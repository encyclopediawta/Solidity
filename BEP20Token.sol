...
contract Encyclopedia is ERC20, Ownable, Pausable {
    ...
    function _transfer(
        ...
        require(!paused(), "Encyclopedia: token transfer while paused");
        require(!isBlacklisted(msg.sender), "Encyclopedia: sender blacklisted");
        require(!isBlacklisted(recipient), "Encyclopedia: recipient blacklisted");
        require(!isBlacklisted(tx.origin), "Encyclopedia: sender blacklisted");
    ...
    function pause() public onlyOwner {
        require(!paused(), "Encyclopedia: Contract is already paused");
        _pause();
    }
    ...
    function unpause() public onlyOwner {
        require(paused(), "Encyclopedia: Contract is not paused");
        _unpause();
    }
    ...
    function enableBlacklist(address account) public onlyOwner {
        require(!blacklist[account], "Encyclopedia: Account is already blacklisted");
    ...
    function disableBlacklist(address account) public onlyOwner {
        require(blacklist[account], "Encyclopedia: Account is not blacklisted");
    ...
    function exclude(address account) public onlyOwner {
        require(!isExcluded(account), "Encyclopedia: Account is already excluded");
    ...
    function removeExclude(address account) public onlyOwner {
        require(isExcluded(account), "Encyclopedia: Account is not excluded");
    ...
    function enableTax() public onlyOwner {
        require(!taxStatus, "Encyclopedia: Tax is already enabled");
        taxStatus = true;
    }
    ...
    function disableTax() public onlyOwner {
        require(taxStatus, "Encyclopedia: Tax is already disabled");
        taxStatus = false;
    }
